...
const PantallaAccesibilidad = () => {
  const [modoOscuro, changeModoOscuro] = useState(true);
    ...
    <>
      ...
      <ContainerPantAcces>
        ...
        <div className="opciones">
          <div>
            <RadioButton opcion="Desactivado" checked={!modoOscuro && true} />
          </div>
          <div>
            <RadioButton opcion="Activado" checked={modoOscuro && true} />
          </div>
        </div>
      </ContainerPantAcces>
    </>
