...
const Login = () => {
  ...
  // Ajustar footer
  const [isRelative, changeIsRelative] = useState(false);
  ...
  const activeRelativeFooter = (active) => {
    if (active) return changeIsRelative(true);
    else return changeIsRelative(false);
  };
      ...
      <ContainerLogin>
        <form action="" onSubmit={handleSubmit}>
          ...
          <input
            ...
            onClick={() => activeRelativeFooter(true)}
            onBlur={() => activeRelativeFooter(false)}
          />
          <input
            type="password"
            name="password"
