...
const Login = () => {
  ...
  const activeRelativeFooter = () => {
    return changeIsRelative(true);
  };
  const desactiveRelativeFooter = () => {
    return changeIsRelative(false);
  };
      ...
      <ContainerLogin>
        <form action="" onSubmit={handleSubmit}>
          ...
          <input
            ...
            onClick={() => activeRelativeFooter()}
            onBlur={desactiveRelativeFooter}
          />
          <input
            type="password"
            name="password"
