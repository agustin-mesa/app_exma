  ...
  img {
    width: ${(props) => {
      props.categorias.map((categoria) => {
        if (props.categoria.nombre === "Compras") return props.categoria.width;
        if (props.categoria.nombre === "Ropa") return props.categoria.width;
        if (props.categoria.nombre === "Cuentas y Pagos")
          return props.categoria.width;
        if (props.categoria.nombre === "Diversión")
          return props.categoria.width;
        if (props.categoria.nombre === "Transporte")
          return props.categoria.width;
      });
    }};
  }
