  ...
  return (
    <>
      ...
      <ContainerRegister>
        ...
        <form action="">
          <h3>Crear cuenta</h3>
          <input type="text" name="nombre" placeholder="Nombre" value={} onChange={}/>
          <input type="email" name="email" placeholder="Correo electrónico" value={} onChange={}/>
          <input
            type="password"
            name="password"
            placeholder="Crea una contraseña" value={} onChange={}
          />
