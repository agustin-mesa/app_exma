            ...
            {gastos.map((gasto, i) => {
              return (
                <div key={i}>
                  ...
                  <ListElement key={gasto.idGasto} idGasto={gasto.idGasto} categoria={gasto.categoria} descripcion={gasto.descrip} precio={gasto.precio} userEmail={user.email} changeShowMsgDeleted={changeShowMsgDeleted}/>
                </div>
              );
            })}
            {gastos.length > 9
