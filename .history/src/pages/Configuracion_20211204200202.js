  ...
  const handleChange = (e) => {
    ...
    switch (inputName) {
      ...
      case "eliminarCuenta":
        ...
        console.log(inputDeleteAcc.length === 17 && "asd");
        if (
          inputDeleteAcc.toLowerCase() === "eliminar mi cuenta" &&
          inputDeleteAcc.length === 17
        ) {
              ...
              <div className="warning">
                <div>
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                  />
                  <button className="btn-editar" disabled={false}>
                    Hasta pronto... :(
                  </button>
                </div>
              </div>
