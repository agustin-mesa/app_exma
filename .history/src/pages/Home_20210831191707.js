...
const HeaderHome = styled.div`
  ...
  img {
    width: ${(props) => {
        ...
        if (categorias[0].nombre === "Compras") return categoria.width;
        if (categorias[1].nombre === "Ropa") return categoria.width;
        if (categorias[2].nombre === "Cuentas y Pagos") return categoria.width;
        if (categorias[3].nombre === "Diversión") return categoria.width;
        if (categorias[4].nombre === "Transporte") return categoria.width;
      });
    }};
  }
`;
