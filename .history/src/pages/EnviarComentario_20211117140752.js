          ...
          <ContainerEnviarComentario>
            <form action="">
              ...
              <p className="info-adicional">
                Google reCAPTCHA es un sistema diseñado para diferenciar entre
                humanos y ordenadores, que se utiliza para que los bots no
                puedan completar formularios de forma malintencionada en nombre
                de un ser humano.
              </p>
