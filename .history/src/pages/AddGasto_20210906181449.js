...
const AddGasto = ({ gasto }) => {
  ...
  const [aumentarWidth, changeAumentarWidth] = useState(150);
  ...
  const handleChange = (e) => {
    if (e.target.name === "descripcion") {
      ...
      if (changeInputValor(e.target.value.replace(/[^0-9.]/g, ""))) {
        changeAumentarWidth(aumentarWidth + 50);
        console.log(aumentarWidth);
      }
    }
  };
