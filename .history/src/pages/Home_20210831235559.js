  ...
  return (
    <>
      ...
      <ContainerHome>
        ...
        <PresentationHome>
          <p>
            <b>EXMA</b> es una app web de <b>registro de gastos</b> para que
            puedas tener la <b>administración de tu economía</b> ordenando por
            categoria y fecha de forma sencilla.
          </p>
...
const HeaderHome = styled.div`
  ...
  img:nth-child(6) {
    position: absolute;
    z-index: 2;
    -webkit-filter: drop-shadow(0px 8px 5px #44444488);
    filter: drop-shadow(0px 8px 5px #44444488);
  }
`;
