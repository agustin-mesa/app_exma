  ...
  return (
    <ContainerGestion>
      <div className="bg-relative">
        ...
        <Navigation />
        <Switch>
          <Route path="/gestion/añadir-gasto" component={AddGasto}></Route>
          <Route path="/gestion/categorias" component={Categorias}></Route>
          <Route path="/gestion/mi-lista" component={MiLista}></Route>
        </Switch>
      </div>
    </ContainerGestion>
  );
