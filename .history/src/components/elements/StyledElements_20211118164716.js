...
const hundir = keyframes`
  0%{
    ...
    box-shadow: 0px 8px 16px var(--violetblueOpac-06);
  }
  50%{
    transform: translateY(5px);
    box-shadow: 0px 3px 10px var(--violetblueOpac-06);
  }
  100%{
    transform: translateY(0);
    box-shadow: 0px 8px 16px var(--violetblueOpac-06);
...
const Boton = styled.button`
  ...
  &.action {
    ...
    color: var(--text__03);
    border: 1px solid var(--violetblue);
    box-shadow: none;
  }
  &.action:focus {
...
const IconCategory = styled.img`
  ...
  height: 40px;
  margin-right: 10px;
  -webkit-filter: drop-shadow(0px 4px 4px var(--blackOpac-05));
  filter: drop-shadow(0px 4px 4px var(--blackOpac-05));
`;
...
const Input = styled.input`
  ...
  margin: 10px 0;
  border-radius: 50px;
  border: solid 1px var(--blackOpac-03);
  color: var(--text__06);
  font-size: 14px;
  font-weight: 600;
  transition: all 0.2s ease;
  ...
  &:focus {
    outline: none;
    color: #505bda;
    border: solid 1px var(--violetblue);
  }
  &::placeholder {
    color: var(--text__05);
    font-weight: 600;
