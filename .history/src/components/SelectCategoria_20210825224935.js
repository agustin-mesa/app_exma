...
const SelectCategoria = ({ categoria, changeCategoria }) => {
  ...
  const categorias = [
    ...
    { id: "cuentas y pagos", text: "Cuentas y Pagos", icon: iconCuentas },
    { id: "transporte", text: "Transporte", icon: iconTransporte },
    { id: "ropa", text: "Ropa", icon: iconRopa },
    { id: "salud e higiene", text: "Salud e Higiene", icon: iconSalud },
    { id: "compras", text: "Compras", icon: iconCompras },
    { id: "diversion", text: "Diversión", icon: iconDiversion },
  ];
            ...
            {categorias.map((categoria) => {
              return (
                <Option
                  ...
                  onClick={handleClick}
                >
                  <IconCategory src={IconCategorias} alt={categoria.id} />
                  {categoria.text}
                </Option>
              );
            })}
